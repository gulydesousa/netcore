...
namespace Tests.ServiceTests
{
    public class StocksServiceTest
    {
        ...
        public StocksServiceTest()
        {
            ...
            _stocksSellService = new StocksSellOrdersService(_stocksRepository);
            _stocksBuyService = new StocksBuyOrdersService(_stocksRepository);
        }
        ...
        public async Task CreateBuyOrder_NullBuyOrder_ToBeArgumentNullException()
        {
            ...
            {
                await _stocksBuyService.CreateBuyOrder(buyOrderRequest);
            };
        ...
        public async Task CreateBuyOrder_ValidData_ToBeSuccessful()
        {
            ...
            //Act
            BuyOrderResponse buyOrderResponseFromCreate = await _stocksBuyService.CreateBuyOrder(buyOrderRequest);
        ...
        public async Task CreateSellOrder_NullSellOrder_ToBeArgumentNullException()
        {
            ...
            Func<Task> action = async () =>
            {
                await _stocksSellService.CreateSellOrder(sellOrderRequest);
            };
        ...
        public async Task CreateSellOrder_ValidData_ToBeSuccessful()
        {
            ...
            //Act
            SellOrderResponse sellOrderResponseFromCreate = await _stocksSellService.CreateSellOrder(sellOrderRequest);
        ...
        public async Task GetAllBuyOrders_DefaultList_ToBeEmpty()
        {
            ...
            //Act
            List<BuyOrderResponse> buyOrdersFromGet = await _stocksBuyService.GetBuyOrders();
    ...
    _fixture.Build<BuyOrder>().Create()
            ...
            //Act
            List<BuyOrderResponse> buyOrders_list_from_get = await _stocksBuyService.GetBuyOrders();
        ...
        public async Task GetAllSellOrders_DefaultList_ToBeEmpty()
        {
            ...
            //Act
            List<SellOrderResponse> sellOrdersFromGet = await _stocksSellService.GetSellOrders();
    ...
    _fixture.Build<SellOrder>().Create()
            ...
            //Act
            List<SellOrderResponse> sellOrders_list_from_get = await _stocksSellService.GetSellOrders();
